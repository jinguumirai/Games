...
namespace GameLib2D
{
    ...
    /// @brief The main class of the 2D Game Engine, you can create instance of this class by
    /// using FrameWork2D::instance()
    class Framework2D
    {
    private:
        Framework2D(const unsigned int width, const unsigned int height, GLFWwindow* const);
        static Framework2D * frame;
    ...
    public:
        ...
        static Framework2D * instance(const int width, const int height, GLFWwindow * const window);
